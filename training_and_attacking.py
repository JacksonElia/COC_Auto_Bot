...
class TrainerAndAttacker:
    ...
    def train_troops(self, screenshot: Image):
        ...
        """
        self.main_window.window_message = "Training troops."
    ...
    def find_base_to_attack(self, screenshot: Image):
        ...
        """
        self.main_window.window_message = "Finding a base to attack."
        ...
        if next_button_rectangle:
            ...
            self.main_window.window_message = "Trying to find a base with a lot of loot."
    ...
    def attack(self, screenshot):
        ...
        :return:
        """
        self.main_window.window_message = "Attacking the base."
        self.troops_trained = False
    ...
    def upgrade_troops(self, screenshot: Image) -> bool:
        ...
        """
        self.main_window.window_message = "Attempting to upgrade troops and spells."
